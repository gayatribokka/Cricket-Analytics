...
def predict():
    ...
    # Score prediction (Model 1)
    predicted_score_pipe = int(pipe.predict(input_df)[0])

    # Score prediction (Ridge model)
    # Note: you may need to one-hot encode manually like your original code if ridge expects a different format
    ...
    # Here you'd add your one-hot encodings (manually or use a better encoder)
    # For now we use a placeholder assuming you have already encoded into 'a'
    # Replace this with actual encoding logic if needed
